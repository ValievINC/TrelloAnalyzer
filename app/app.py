from PyQt6.QtWidgets import QApplication, QMainWindow, QPushButton, QLineEdit, QVBoxLayout, QLabel, QWidget, QCheckBox, QFileDialog
...
class MainWindow(QMainWindow):
    ...
    def create_file(self):
        ...
        if self.checkbox.checkState() == Qt.CheckState.Checked:
            print('xlsx')
            checking_trello.create_new_excel_file(inp, out + '.xlsx')
        else:
            print('csv')
            checking_trello.create_new_csv(inp, out + '.csv')
